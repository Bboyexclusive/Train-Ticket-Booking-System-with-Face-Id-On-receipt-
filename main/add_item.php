...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<table border="0" cellspacing="0" cellpadding="2" width="500">
		<tr>
		<td class="pageName">ADD TRAIN TIME </td>
		</tr>
...
<form action="add_item_ac.php" method="post" enctype="multipart/form-data">
  <tr>
    <td width="180">Train Location:<input type="text" name="name" placeholder="Train departure" required/></td>
    <td width="201">Train Seats Capacity:<input type="number" name="quant" placeholder="Enter Ticket Quantity" required/></td>
  </tr>
   <tr>
    <td width="180">Pprice Per Ticket:<input type="number" name="price" placeholder="Ticket Price" required/></td>
    <td width="201">Train Destination :<input type="text" name="dest" placeholder="Train Destination" required/></td>
  </tr>
  <tr>
